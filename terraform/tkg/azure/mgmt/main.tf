module "tkg_azure_mgmt_cluster" {
  source = "git::https://github.com/pacphi/tf4k8s.git//modules/cluster/tkg/azure/mgmt"
...
output "config_yaml_contents" {
  value = file(module.tkg_azure_mgmt_cluster.path_to_config_yaml)
}